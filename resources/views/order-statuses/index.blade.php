...
@section('page-title', 'Управление статусами заказов')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="mb-0">Статусы заказов</h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="white-space: nowrap;">
                        <a href="{{ route('admin.order-statuses.edit', $status) }}" class="btn btn-warning" style="padding: 2px 8px; font-size: 11px; width: 100px; display: inline-block; text-align: center; margin-right: 5px;">Редактировать</a>
                        <form action="{{ route('admin.order-statuses.destroy', $status) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
